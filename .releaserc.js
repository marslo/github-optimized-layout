...
module.exports = {
  ...
  "plugins": [
    ["@semantic-release/commit-analyzer", {
      ...
      "releaseRules": [
        // breaking change (`type!:` / `BREAKING CHANGE:`) must win over the
        // per-type patch rules below, else `refactor!` is downgraded to patch
    ...
    ["@semantic-release/exec", {
      // repo-specific: keep the userstyle @version header in sync with the release
      // (Stylus auto-update keys off @version), then let pre-commit tidy both files.
